...
E-Converse es una tienda virtual con gestión integral de usuarios, productos, carrito de compras, pasarela de pagos simulada y gestión de pedidos. La comunicación entre frontend y backend se realiza mediante una API REST protegida con JWT.

\begin{figure}[H]
    \centering
    % Reemplazar por diagrama de arquitectura
    \includegraphics[width=0.85\textwidth]{Imagenes/arquitectura_general.png}
    \caption{Arquitectura general de E-Converse}
...
El pipeline se compone de \textbf{4 jobs secuenciales} definidos en el archivo \texttt{.github/workflows/ci-cd.yml}:
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Imagenes/github_actions_build.png}
    \caption{Ejecución del Job Build \& Test en GitHub Actions}
    \label{fig:gh_build}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Imagenes/dockerhub_images.png}
    \caption{Imágenes publicadas en Docker Hub}
    \label{fig:dockerhub}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Imagenes/github_actions_deploy.png}
    \caption{Ejecución del despliegue en GitHub Actions}
    \label{fig:gh_deploy}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Imagenes/tests_results.png}
    \caption{Resultados de la ejecución de pruebas unitarias}
    \label{fig:tests_results}
\end{figure}
...
\subsection{Ejecución exitosa del pipeline completo}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Imagenes/pipeline_completo.png}
    \caption{Pipeline completo ejecutado exitosamente en GitHub Actions}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{Imagenes/deploy_containers.png}
    \caption{Contenedores ejecutándose en el servidor de despliegue}
    \label{fig:deploy_containers}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Imagenes/email_success.png}
    \caption{Correo de notificación de éxito recibido}
    \label{fig:email_success}
\end{figure}
...
\begin{itemize}
    ...
    \item El despliegue mediante SSH permite actualizar servidores remotos de forma automatizada y segura.
\end{itemize}
